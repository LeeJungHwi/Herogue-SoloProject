...
{
    // 스킬1 인스턴스
    private GameObject instantAbilityArrow1Active;
    ...
    public override void DeAtivate(GameObject joystick, GameObject player, GameObject poolingManager)
    {
        ...
        // 충돌 이펙트 풀에 반환
        for (int i = 0; i < poolManager.AbilityArrow1HitEffects.Count; i++) poolManager.ReturnObj(poolManager.AbilityArrow1HitEffects[i].Item1, poolManager.AbilityArrow1HitEffects[i].Item2);
