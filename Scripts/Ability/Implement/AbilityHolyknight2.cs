...
{
    // 스킬2 인스턴스
    private GameObject instantAbilityHolyknight2;
    ...
    public override void Activate(GameObject joystick, GameObject player, GameObject poolingManager)
    {
        ...
        // 스킬 이펙트
        instantAbilityHolyknight2 = poolManager.GetObj(ObjType.성기사스킬3이펙트);
        ...
        // 스킬 사운드
        SoundManager.instance.SFXPlay(ObjType.성기사스킬3소리);
    }
    ...
    public override void DeAtivate(GameObject joystick, GameObject player, GameObject poolingManager)
    {
        ...
        // 스킬 이펙트 풀에 반환
        poolManager.ReturnObj(instantAbilityHolyknight2, ObjType.성기사스킬3이펙트);
    }
}
